...
public class ProductServiceImp implements ProductService{
    private static final List<Product> products = new ArrayList<>(List.of(
            new Product(101, "Milk", "Alimentacion",  1000.00),
            new Product(102, "Jabon", "Limpieza", 450.00),
            new Product(103, "Table", "Hogar",  10000.00),
            new Product(104, "Eggs", "Alimentacion",  3000.00)
    ));
