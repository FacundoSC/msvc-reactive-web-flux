...
public class ElementsServiceImpl implements  ElementsService{
    private final String urlFirstStore ="http://MSVC_CRUD_PRODUCTOS_REACTIVO_TIENDA_1";
    private final String urlSecondStore ="http://MSVC_CRUD_PRODUCTOS_REACTIVO_TIENDA_2";
    @Autowired
